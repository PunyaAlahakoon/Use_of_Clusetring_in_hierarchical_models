...
betas=load('independent_beta_d1.mat');
betas=betas.beta_smc;
gammas=load('independent_gamma_d1.mat');
gammas=gammas.gamma_smc;
epsilons=load('independent_epsilon_d1.mat');
...
save('independent_beta_d11.mat','beta_smc');
save('independent_gamma_d11.mat','gamma_smc');
save('independent_epsilon_d11.mat','epsilon_smc');
%save('E_smc1','E_smc');
