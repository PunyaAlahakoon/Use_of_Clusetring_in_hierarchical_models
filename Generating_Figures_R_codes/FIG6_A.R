...
g1=data.frame(g1_beta,"Estimation"=rep("Cluster 2 of 2",1000))
colnames(g1)=c(g1_names,"Estimation")
m1=melt(g1)
g2=data.frame(g2_beta,"Estimation"=rep("Cluster 1 of 2",1000))
...
ggsave(filename = "ridge_betas_cluster2_groups.png", p1,
       width = 8, height = 25, units = "in", device='png')
