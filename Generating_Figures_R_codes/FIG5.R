...
all_hb=data.frame(all_hb[,1],"Method"=rep("One cluster",1000))
...
g1_hb=data.frame(g1_hb[,1],"Method"=rep("Cluster 2 of 2",1000))


g2_hb=readMat('2C_hb_g2_all.mat')
g2_hb=g2_hb$hb
g2_hb=t(g2_hb[,5001:6000])
g2_hb=data.frame(g2_hb[,1],"Method"=rep("Cluster 1 of 2",1000))
...
colnames(mes)<-c("One cluster","Group A","Group B","Group C","variable")
mms=melt(mes)
colnames(mms)<-c("variable","Method","value")


lv=c("One cluster","Cluster 1 of 2","Cluster 2 of 2")
...
p1=ggplot()+
 ...
 # geom_point(data=mms,aes(x=value,y=0,colour=factor(Method)), size = 3.5,shape=8)+
...
g1_hb=g1_hb$hb
g1_hb=t(g1_hb[,5001:6000])
g1_hb=data.frame(g1_hb[,1],"Method"=rep("Cluster 3 of 3",1000))


g2_hb=readMat('C3_hb_g2_all.mat')
g2_hb=g2_hb$hb
g2_hb=t(g2_hb[,5001:6000])
g2_hb=data.frame(g2_hb[,1],"Method"=rep("Cluster 1 of 3",1000))

g3_hb=readMat('C3_hb_g3_all.mat')
g3_hb=g3_hb$hb
g3_hb=t(g3_hb[,5001:6000])
g3_hb=data.frame(g3_hb[,1],"Method"=rep("Cluster 2 of 3",1000))
...
lv=c("One cluster","Cluster 1 of 3","Cluster 2 of 3","Cluster 3 of 3")
dd$Method=factor(dd$Method,levels = lv)
...
ggsave("group_cluster_hyper_betas.png",last_plot(),height = 6,width = 8)
