...
hie_bet=readMat('hie_123_epsilon_d123.mat')

A_hie_bet=hie_bet$epsilon.smc
...
#load group 1 data:
g1_beta=readMat('hie_cluster3_epsilon_g1.mat')
g1_beta=g1_beta$epsilon.smc

g2_beta=readMat('hie_cluster3_epsilon_g2.mat')
g2_beta=g2_beta$epsilon.smc

g3_beta=readMat('hie_cluster3_epsilon_g3.mat')
g3_beta=g3_beta$epsilon.smc
...
ggsave(filename = "ridge_mus_cluster2_3_groups.png", last_plot(),
