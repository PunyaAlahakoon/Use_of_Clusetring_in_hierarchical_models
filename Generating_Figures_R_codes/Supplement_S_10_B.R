...
#load group 1 data:
g1_beta=readMat('hie_cluster3_gamma_g1.mat')
g1_beta=g1_beta$gamma.smc

g2_beta=readMat('hie_cluster3_gamma_g2.mat')
g2_beta=g2_beta$gamma.smc

g3_beta=readMat('hie_cluster3_gamma_g3.mat')
g3_beta=g3_beta$gamma.smc
...
ggsave(filename = "ridge_gammas_cluster2_3_groups.png", last_plot(),
