...
save('s_x_smc1.mat','s_x');
save('independent_beta_d3.mat','beta_smc');
save('independent_gamma_d3.mat','gamma_smc');
save('independent_epsilon_d3.mat','epsilon_smc');
save('E_smc1','E_smc');
