...
for k=1:dim   %consider the kth population  
...
save('independent_beta_d1.mat','beta_smc');
save('independent_gamma_d1.mat','gamma_smc');
save('independent_epsilon_d1.mat','epsilon_smc');
save('E_smc','E_smc');
