...
betas=load('independent_beta_d2.mat');
betas=betas.beta_smc;
gammas=load('independent_gamma_d2.mat');
gammas=gammas.gamma_smc;
epsilons=load('independent_epsilon_d2.mat');
...
save('independent_beta_d22.mat','beta_smc');
save('independent_gamma_d22.mat','gamma_smc');
save('independent_epsilon_d22.mat','epsilon_smc');
%save('E_smc1','E_smc');
