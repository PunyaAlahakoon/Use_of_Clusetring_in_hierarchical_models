...
me=beta_smc(:,1:10); %from Step (1)--a  
...
r=0.001; s=10; %truncated interval for truncated normal 
w=weight4(me,hb(1),hb_sig(1),dim,r,s);

p(1)=w*unifpdf(hb(1),r,s)*unifpdf(hb_sig(1),0,2.5);
...
for i=2:N
   ...
   prior=unifpdf(hm_r,r,s)*unifpdf(sig_r,0,2.5);
